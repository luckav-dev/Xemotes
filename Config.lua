Config = {
		...
		CustomMenuEnabled = true,
 		MenuImage = "https://cdn.discordapp.com/attachments/949812095891943455/1057033591793659976/menu.PNG",
		MenuPosition = "right",
	...
	Config.Languages = {
	  ['en'] = {
			['emotes'] = 'Emotes',
			['newemotes'] = '🆕 → New Emotes',
			['danceemotes'] = "🕺 → Dance Emotes",
			['gangsignemotes'] = "🤙 → Gang Signs",
			['newpropemotes'] = "📸 → New Prop Emotes",
			['posesemotes'] = "🙆‍♀️ ~y~Poses Female",
			['posesmaleemotes'] = "🙆🏻‍♂️ ~y~Poses Male",
			['propemotes'] = "📦 → Prop Emotes",
			['oldemotes'] = "👴🏻 → Old Emotes",
